...
import (
	"context"
	"fmt"
	database "go-lang-jwt-project/databases"
	helper "go-lang-jwt-project/helpers"
	"go-lang-jwt-project/models"
	"log"
	"net/http"
	"strconv"
	"time"
...
// this function is for Admin only. He will get acces for all data of users. Only admin can call
